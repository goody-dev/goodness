...
class About extends React.Component {
    ...
    render () {
        return (
        <div id="about" className="surface1-dark w-100 p-4 p-sm-5 p-md-3 d-flex flex-column flex-sm-row-reverse justify-content-center align-items-sm-center" style={{maxHeight:700, height: '100vh'}}>
