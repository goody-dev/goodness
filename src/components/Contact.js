  ...
  render() {
    return (
      <div id="contact" className="surface1-dark w-100 p-5 align-items-center" style={{height: 'fit-content', color: '#00ADB5'}}>
         ...
         <form class="container d-flex flex-column text-start rounded-4 p-3 w-sm-70" style={{border:'2px solid #00ADB5', maxWidth: 500}} action="mailto: goodnessokanlawon12@gmail.com" method="POST">
            <label for="email" className="d-flex flex-column my-2">Email
            <input required name="email" id="email" type="email" placeHolder="Enter your email" className="surface2-dark border-0 rounded-3" style={{height:50}}/>
            </label> 
            <label for="name" className="d-flex flex-column my-2">Name
            <input id="name" required name="fullname" type="text" placeHolder="Enter your name" className="surface2-dark border-0 rounded-3" style={{height:50}}/>
            </label>
            <label for="message" className="d-flex flex-column my-2">Got some info for me?
            <textarea name="detail" id="name" type="text" placeHolder="Message" className="surface2-dark border-0 rounded-3" style={{height: 100}} />
            </label>
